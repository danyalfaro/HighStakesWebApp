...
const weatherAlertHeadlines = require("./weather-alert-headlines");
const weatherAlertDetails = require("./weather-alert-details");
// const tropicalForecastProjectedPath = require('./tropical-forecast-projected-path')
const dailyForecast = require("./daily-forecast");
// const severeWeatherPower = require("./severe-weather-power-disruption-index");
...
const callWeatherAlertDetails = function (detailKey) {
  ...
  request(options).then(weatherAlertDetails.handleResponse).catch(handleFail);
};
...
//   request(options).then(severeWeatherPower.handleResponse).catch(handleFail);
// };
...
export default callDailyForecast;
